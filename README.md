...
<section class="about-section py-5 bg-light rounded-3">
    <div class="container">
        <!-- Heading -->
        <div class="text-center mb-5">
            <h6 class="text-uppercase text-muted">Who I Am</h6>
            <h2 class="fw-bold text-dark">A <span class="text-danger">WordPress Developer</span> Focused on Quality</h2>
            <p class="text-secondary mt-3 mx-auto" style="max-width: 700px;">
                I specialize in creating professional, responsive, and user-friendly websites that help brands
                stand out online. My skills include WordPress development, custom themes, plugin customization,
                and SEO-friendly designs.
            </p>
        </div>
        ...
        <div class="row text-center g-4">
            <div class="col-md-3">
                <div class="p-4 shadow-sm rounded bg-white h-100">
                    ...
                    <p class="text-muted mb-0">Harvard University – Programming Course</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="p-4 shadow-sm rounded bg-white h-100">
                    <i class="fas fa-briefcase fa-2x text-danger mb-3"></i>
                    <h5 class="fw-semibold">Experience</h5>
                    <p class="text-muted mb-0">5+ Years building custom websites and plugins.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="p-4 shadow-sm rounded bg-white h-100">
                    <i class="fas fa-cogs fa-2x text-danger mb-3"></i>
                    <h5 class="fw-semibold">Professional Skills</h5>
                    <p class="text-muted mb-0">WordPress, PHP, Laravel, JavaScript, SEO.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="p-4 shadow-sm rounded bg-white h-100">
                    <i class="fas fa-award fa-2x text-danger mb-3"></i>
                    <h5 class="fw-semibold">Awards</h5>
                    <p class="text-muted mb-0">Recognized for delivering top-quality web solutions.</p>
                </div>
            </div>
        </div>
    </div>
