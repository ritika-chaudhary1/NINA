            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p class="hero-text">
                            I'm a Web developer & I'm very passionate and dedicated to my work. I have acquired the skills and knowledge
    ...
    <section class="services-section py-5 mt-3 mb-2 rounded-3">
        <div class="container px-5">
            ...
            <h2 class="section-title text-black text-center">What <span class="text-danger">Services</span> I Provide To My Clients In Here</h2>
           ...
           <div class="row py-3 border-top border-bottom border-secondary">
            ...
            <div class="col-12 col-lg-8">
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill">WordPress </span> 
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> Brand </span>
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> Laravel </span>
            </div>
           </div>
           ...
           <div class="row py-3 border-bottom border-secondary">
            ...
            <div class="col-12 col-lg-8">
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill">UI/UX Design </span> 
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> Landing </span>
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> Mobile & Web App </span>
            </div>
           </div>
           ...
           <div class="row py-3 border-bottom border-secondary">
            ...
            <div class="col-12 col-lg-8">
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill">Stationery </span> 
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> Brand Design </span>
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> Card Design </span>
            </div>
           </div>
           ...
           <div class="row py-3 border-bottom border-secondary">
            ...
            <div class="col-12 col-lg-8">
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill">Social Media </span> 
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> Youtube </span>
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> SEO Analytics </span>
            </div>
           </div>
           ...
           <div class="row py-3 border-bottom border-secondary">
            ...
            <div class="col-12 col-lg-8">
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill">Mockup Design </span> 
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> Flyer Design </span>
                <span class="text-start d-none d-sm-inline-block px-3 py-1 border border-secondary rounded-pill"> Card Design </span>
            </div>
           </div>
   ...
   <section class="projects-section py-5 bg-light mt-3 mb-2 rounded-3">
    ...
    <section class="about-section py-5 mt-3 mb-2 rounded-3">
        <div class="container">
            ...
            <h2 class="section-title text-black text-center">I Develop <span class="text-danger">Skills</span> Regularly to keep Me Update</h2>
   ...
   <section class="testimonials-section py-5 bg-light mt-3 mb-2 rounded-3">
    <div class="container">
        ...
        <h2 class="section-title text-black text-center">The Best <span class="text-danger">Customers</span> Says About Me</h2>
        ...
        <div class="row py-4 border-bottom border-secondary">
            <div class="col-12 text-center col-lg-8 text-lg-start">
                ...
                <img class="rounded-circle customers" src="{{ asset('images/customer-4.jpg') }}" alt="customers">
                <img class="rounded-circle customers" src="{{ asset('images/customer-5.jpg') }}" alt="customers">
            </div>
            <div class="col-12 d-flex justify-content-center col-lg-4 text-lg-end">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
                class="testinomials-icons p-2 text-light rounded-circle">
        ...
        <div class="row pt-4 text-center">
            <p class="fw-bold">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem aperiam fugiat reprehenderit deleniti porro officiis voluptate nihil, qui, labore eius sequi, consectetur pariatur aliquid repellat consequatur ipsum quos iusto distinctio beatae! Quaerat dolor reprehenderit assumenda voluptas aut omnis id itaque.
            </p>
            <h3 class="fw-bold">
                Jone Nicolas
            </h3>
        ...
        <div class="container-fluid ">
            <div class="container border-top border-bottom border-dark mb-4">
                <div  class="container d-flex justify-content-center gap-md-4 overflow-x-hidden">
                    <div class="clients-brand text-white py-5 px-5 fs-4 fw-bold border border-dark rounded-3">amazon</div>
                    <div class="clients-brand text-white py-5 px-5 fs-4 fw-bold border border-dark rounded-3">slack</div>
                    <div class="clients-brand text-white py-5 px-5 fs-4 fw-bold border border-dark rounded-3">Google</div>
                    <div class="clients-brand text-white py-5 px-5 fs-4 fw-bold border border-dark rounded-3">Linkedin</div>
                    <div class="clients-brand text-white py-5 px-5 fs-4 fw-bold border border-dark rounded-3">Walmart</div>
    ...
    <section class="pricing-section py-5 mt-3 mb-2 rounded-3">
        <div class="container">
            ...
            <h2 class="section-title text-black text-center mb-5">The Best <span class="text-danger">Pricing</span> Plans To Get Your Best</h2>

            <div class="row">
                <div class="col-md-4">
                    <div class="pricing-card">
                        <h3 class="pricing-title">HOURLY BASIS</h3>
                        <p class="pricing-description">Nam libero tempore, cum soluta quo minus maxime placeat facere</p>
  ...
  <section class="blog-section py-5 mt-3 mb-2 rounded-3">
    <div class="container">
        ...
        <h2 class="section-title text-black text-center mb-5">Visit <span class="text-danger">My Blog</span> And Keep Your Feedback</h2>
